...
describe('ReplyRepository interface', () => {
  it('should throw error when invoke abstract behavior', async () => {
    ...
    await expect(replyRepository.getRepliesById('')).rejects.toThrowError('REPLY_REPOSITORY.METHOD_NOT_IMPLEMENTED');
    await expect(replyRepository.verifyReplyExistById('')).rejects.toThrowError('REPLY_REPOSITORY.METHOD_NOT_IMPLEMENTED');
